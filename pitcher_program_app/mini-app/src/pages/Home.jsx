  ...
  return (
    <div style={{ paddingBottom: 20 }}>
      ...
      {(morningBrief || !todayEntry) && (
        <div style={{ margin: '8px 12px 0', background: '#fdf8f8', borderLeft: '3px solid var(--color-maroon)', borderRadius: '0 10px 10px 0', padding: '10px 14px' }}>
          ...
          {morningBrief != null && <p style={{ fontSize: 11, color: 'var(--color-ink-secondary)', lineHeight: 1.6, fontStyle: 'italic', margin: 0 }}>{String(morningBrief)}</p>}
          {todayEntry && (
      ...
      <div style={{ padding: '0 12px' }}>
        {isNewPitcher ? (
          <div style={{ background: '#fff', borderRadius: 12, padding: 16, textAlign: 'center', marginTop: 12 }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--color-ink-muted)' }}>{'Head to Coach to check in or log an outing to get your first plan.'}</p>
          </div>
        ) : (
          <>
            {isViewingPast && (
